// This will Initialize an empty array to store tasks
let tasks = [];

// First of all we will get necessary DOM elements
...
//Then we will define a function to add a task to the DOM
...
// Then define a function to render the task list
function renderList () {
    taskList.innerHTML = '';
...
// Now define a function to mark a task as complete
...
// Also define a function to delete a task
...
// Then a function to add a task to the tasks array
...
function handleInputKeypress(e){
    if(e.key == 'Enter' || e.type == 'mousedown'){
        ...
        addTaskInput.value = ''; // Using addTaskInput instead of e.target
        addTask(task);
    }
}
...
function initializeApp(){
    ...
    button.addEventListener('mousedown', handleInputKeypress); // Changing event listener to 'mousedown'
